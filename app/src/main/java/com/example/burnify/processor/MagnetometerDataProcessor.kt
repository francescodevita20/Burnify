...
/**
 * This class processes magnetometer measurements and extracts various statistical and spectral features.
 */
class MagnetometerDataProcessor {

    /**
     * Processes raw magnetometer measurements and returns a processed sample with various features.
     *
     * @param measurements The raw magnetometer measurements.
     * @return A MagnetometerProcessedSample containing the calculated features.
     */
    fun processMeasurementsToEntity(measurements: MagnetometerMeasurements): MagnetometerProcessedSample {
        // Extract the x, y, z values from the raw measurements
        ...
        // Get the current timestamp for processed data
        ...
        // Return a MagnetometerProcessedSample with calculated features
    ...
    // Calculate the Time Entropy (a normalized form of entropy)
