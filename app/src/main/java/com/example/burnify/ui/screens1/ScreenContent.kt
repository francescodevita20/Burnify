package com.example.burnify.ui.screens1
...
fun ScreenContent(
    ...
    lastPredictionViewModel: LastPredictionViewModel = viewModel() // ViewModel for last prediction data
) {
    ...
    when (selectedPage) {
        ...
        "Data" -> DataScreen(
            ...
            lastPredictionViewModel = lastPredictionViewModel // Pass the predicted activity ViewModel
        )
